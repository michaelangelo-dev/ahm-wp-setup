...
final class AHM_WebP_Admin
{
                ...
                <table class="form-table ahm-settings-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php esc_html_e('Covers inline styles, <style> blocks, and Elementor data-settings. Only serves WebP to browsers that support it (Accept header detection).', 'ahm-core'); ?>
                            </p>
                        </td>
                    </tr>
    ...
    private function render_statistics(): void
    {
        ...
        <div class="ahm-stats-grid">
            <div class="ahm-stat">
                <span class="ahm-stat__number"><?php echo esc_html((string) $total); ?></span>
                <span class="ahm-stat__label"><?php esc_html_e('Total Images', 'ahm-core'); ?></span>
            </div>
            <div class="ahm-stat">
                <span class="ahm-stat__number ahm-stat__number--success"><?php echo esc_html((string) $converted); ?></span>
                <span class="ahm-stat__label"><?php esc_html_e('Converted', 'ahm-core'); ?></span>
            </div>
            <div class="ahm-stat">
                <span class="ahm-stat__number ahm-stat__number--warning"><?php echo esc_html((string) $pending); ?></span>
                <span class="ahm-stat__label"><?php esc_html_e('Pending', 'ahm-core'); ?></span>
            </div>
            <div class="ahm-stat">
                <span class="ahm-stat__number"><?php echo esc_html((string) $webp_native); ?></span>
